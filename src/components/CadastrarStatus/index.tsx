...
export const CadastrarStatus = ({ urlApi, title }: IUrlProps) => {
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <Box
                          sx={{
                            ...
                            height: 8,
                            borderRadius: '50%',
                            backgroundColor: row?.color, // Defina a cor da bolinha aqui
                            marginRight: 0.8 // Espaço entre a bolinha e o texto
                          }}
                        />
                        <Box
                          sx={{
            ...
            return (
              <Form>
                <Stack direction="column" gap={1}>
                  ...
                  <Input name="color" label="Cor Fundo" type="color" />
                </Stack>
